...
type Options struct {
	...
	OIDCGroups                       []string `flag:"oidc-group" cfg:"oidc_group" env:"OAUTH2_PROXY_OIDC_GROUP"`
...
func parseProviderInfo(o *Options, msgs []string) []string {
	...
	case *providers.OIDCProvider:
		...
		if o.OIDCGroupsClaim == "" && len(o.OIDCGroups) > 0 {
			msgs = append(msgs, "oidc required oidc-groups-claim to use oidc-group option")
		} else {
			p.GroupsClaim = o.OIDCGroupsClaim
			p.AllowedGroups = o.OIDCGroups
		}
