...
func NewProvider(providerConfig options.Provider) (Provider, error) {
	...
	case options.AzureEntraOIDCProvider:
		return NewAzureEntraOIDCProvider(providerData, providerConfig), nil
...
func providerRequiresOIDCProviderVerifier(providerType options.ProviderType) (bool, error) {
	...
	case options.BitbucketProvider, options.DigitalOceanProvider, options.FacebookProvider, options.GitHubProvider,
		...
		return false, nil
	case options.ADFSProvider, options.AzureProvider, options.GitLabProvider, options.KeycloakOIDCProvider, options.OIDCProvider, options.AzureEntraOIDCProvider:
		return true, nil
	default:
