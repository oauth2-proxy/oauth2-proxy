...
import (
	...
	sessionscookie "github.com/oauth2-proxy/oauth2-proxy/v6/pkg/sessions/cookie"
	"github.com/oauth2-proxy/oauth2-proxy/v6/pkg/sessions/persistence"
	"github.com/oauth2-proxy/oauth2-proxy/v6/pkg/sessions/redis"
