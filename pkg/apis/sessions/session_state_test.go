...
func TestString(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user ProviderID:providerid}",
		},
		{
			name: "Full Session",
			sessionState: &SessionState{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user ProviderID:providerid token:true id_token:true created:2000-01-01 00:00:00 +0000 UTC expires:2000-01-01 01:00:00 +0000 UTC refresh_token:true}",
		},
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user ProviderID:providerid created:2000-01-01 00:00:00 +0000 UTC}",
		},
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user ProviderID:providerid expires:2000-01-01 01:00:00 +0000 UTC}",
		},
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user ProviderID:providerid token:true}",
		},
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user ProviderID:providerid id_token:true}",
		},
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user ProviderID:providerid refresh_token:true}",
		},
	}
