...
type Cookie struct {
	...
	Refresh        bool          `flag:"cookie-refresh" cfg:"cookie_refresh"`
	RefreshPercent uint8         `flag:"cookie-refresh-percent" cfg:"cookie_refresh_percent"`
...
func cookieFlagSet() *pflag.FlagSet {
	...
	flagSet.Bool("cookie-refresh", true, "set cookie refresh flag")
	flagSet.Uint8("cookie-refresh-percent", 85, "set cookie refresh percentage of the token expiry period; [1, 100]")
