...
type LegacyProvider struct {
	...
	AzureCookieRefresh       string   `flag:"cookie-refresh" cfg:"cookie_refresh"`
...
func legacyProviderFlagSet() *pflag.FlagSet {
	...
	flagSet.String("azure-cookie-refresh", "", "refresh the cookie after this duration; 0 to disable; not supported by all providers")
...
func (l *LegacyProvider) convert() (Providers, error) {
	...
	provider.AzureConfig = AzureOptions{
		...
		CookieRefresh:   l.AzureCookieRefresh,
	}
