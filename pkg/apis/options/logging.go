...
type Logging struct {
	...
	RequestEnabled  bool           `json:"requestEnabled,omitempty"`
	RequestFormat   string         `json:"requestFormat,omitempty"`
	StandardEnabled bool           `json:"standardEnabled,omitempty"`
	StandardFormat  string         `json:"standardFormat,omitempty"`
	ErrToInfo       bool           `json:"errToInfo,omitempty"`
	ExcludePaths    []string       `json:"excludePaths,omitempty"`
	LocalTime       bool           `json:"localTime,omitempty"`
	SilencePing     bool           `json:"silencePing,omitempty"`
