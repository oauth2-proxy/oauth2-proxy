...
type Options struct {
	...
	DenyInvalidBearerTokens bool     `flag:"deny-invalid-bearer-tokens" cfg:"deny_invalid_bearer_tokens"`
...
func NewFlagSet() *pflag.FlagSet {
	...
	flagSet.Bool("deny-invalid-bearer-tokens", false, "if skip-jwt-bearer-tokens is set, respond 403 to requests with invalid JWTs")
