...
type Options struct {
	...
	UseRedirectPage       bool     `flag:"use-redirect-page" cfg:"use_redirect_page"`
...
func NewFlagSet() *pflag.FlagSet {
	...
	flagSet.Bool("use-redirect-page", false, "Instead of redirecting to redirect-url with HTTP 302 Found, go to a redirect page to perform a meta refresh redirect to redirect-url with HTTP 200 OK.")
