...
type Options struct {
	...
	PassAllRequests       bool     `flag:"pass-all-requests" cfg:"pass_all_requests"`
...
func NewFlagSet() *pflag.FlagSet {
	...
	flagSet.Bool("pass-all-requests", false, "will pass/allow all requests without a valid session.")
