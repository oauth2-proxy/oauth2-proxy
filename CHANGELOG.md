...
- [#3107](https://github.com/oauth2-proxy/oauth2-proxy/pull/3107) feat: Logfield quotation parity - removing quotes from RequestID and UserAgent #3107 (@ricardo-mestre)
