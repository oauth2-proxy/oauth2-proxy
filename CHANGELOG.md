...
- [#1210](https://github.com/oauth2-proxy/oauth2-proxy/pull/1210) New `keycloak-oidc` provider added with support for role based authentication. Will eventually deprecate the current keycloak auth provider.
