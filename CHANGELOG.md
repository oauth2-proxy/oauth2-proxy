...
- [#928](https://github.com/oauth2-proxy/oauth2-proxy/pull/928) Extend `email-domain` validation with sub-domain capability, by allowing `.` to the domain (@morarucostel)
