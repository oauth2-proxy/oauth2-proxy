...
func main() {
	...
	flagSet.String("github-repos", "", "restrict logins to collaborators of these repos")
	flagSet.String("github-owner-token", "", "owner token that has access to check collaborators of github-repos")
