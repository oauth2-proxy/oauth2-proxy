...
func main() {
	...
	flagSet.StringSlice("api-path-regex", []string{}, "bypass redirect to OAuth provider for requests paths that match and return HTTP status code 401 instead (may be given multiple times)")
