...
func main() {
	...
	flagSet.String("github-repo", "", "restrict logins to collaborators of this repo")
	flagSet.String("github-owner-token", "", "owner token that has access to check collaborators of github-repo")
