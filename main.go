...
func main() {
	...
	flagSet.Var(&claimAuthorizations, "claim-authorization", "JMESPath (https://jmespath.org/) expressions that the claims in the id_token must match (at least one of) in order to be considered valid")
