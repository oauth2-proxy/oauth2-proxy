...
of selected request information and the request body [see `SignatureHeaders`
in `pkg/upstream/http.go`](https://github.com/oauth2-proxy/oauth2-proxy/blob/master/pkg/upstream/http.go).
