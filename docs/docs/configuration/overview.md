...
| flag: `--introspection-url`<br/>toml:`introspection_url`                                            | string         | OAuth2 introspection endpoint                                                                                                                                                                            |                       |
| flag: `--introspect-token`<br/>toml:`introspect_token`                                              | bool           | if `--skip-jwt-bearer-tokens` or `--skip-bearer-tokens` is set, introspect token for passed bearer token using introspection endpoint&nbsp;\[[3](#footnote3)\]                                           | false                 |
