...
| flag: `--oidc-email-claim`<br/>toml: `oidc_email_claim`                                             | string         | which OIDC claim contains the user's email. When starting with `@.`, the claim is interpreted as a [JMES Path](https://jmespath.org/).                                                                  | `"email"`             |
...
| flag: `--oidc-groups-claim`<br/>toml: `oidc_groups_claim`                                           | string         | which OIDC claim contains the user groups. When starting with `@.`, the claim is interpreted as a [JMES Path](https://jmespath.org/).                                                                   | `"groups"`            |
