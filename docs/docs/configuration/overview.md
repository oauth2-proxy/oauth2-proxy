...
| flag: `--oidc-preferred-username-claim`<br/>toml: `oidc_preferred_username_claim`                   | string         | which OIDC claim contains the user's preferred username                                                                                                                                                  | `"preferred_username"`|
