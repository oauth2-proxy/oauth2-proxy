...
| flag: `--session-store-type`<br/>toml: `session_store_type`                         | string         | [Session data storage backend](sessions.md); cookie, redis or http                                                                                                                                                                                                                                                                                                                                                  | cookie  |
...
| flag: `--http-store-base-url`<br/>toml: `http_store_base_url`                       | string         | Base URL of the [HTTP session storage](sessions.md#http-storage) backend (e.g. `https://session-store.example.com`). Required when `--session-store-type=http`                                                                                                                                                                                                                                                 |         |
| flag: `--http-store-api-key`<br/>toml: `http_store_api_key`                         | string         | API key sent as a `Bearer` token when authenticating with the HTTP session storage backend                                                                                                                                                                                                                                                                                                                    |         |
