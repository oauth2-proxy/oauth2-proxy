...
| `skipDiscovery` | _bool_ | SkipDiscovery allows to skip OIDC discovery and use manually supplied Endpoints or Key files<br/>default set to 'false'                                                                                                                                                                                                                                           |
| `jwksURL` | _string_ | JwksURL is the OpenID Connect JWKS URL. To be used in conjunction with `skipDiscovery`.<br/>eg: https://www.googleapis.com/oauth2/v3/certs                                                                                                                                                                                                                            |
| `publicKeys` | _[]string_ | PublicKeys is a list of paths pointing to public key files used to validate the JWT tokens (PEM format). To be used in conjunction with `skipDiscovery`. This option and jwksURL are mutually exclusive.                                                                                                                                                         |
