...
| `preferredUsernameClaim` | _string_ | PreferredUsernameClaim indicates which claim contains the user's preferred username<br/>default set to 'preferred_username' |
