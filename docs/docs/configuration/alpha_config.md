...
| `insecureSkipIssuerVerification` | _bool_ | InsecureSkipSignatureCheck skips JWT signature validation.<br/>It's intended for special cases where providers (such as Azure), use the "none" algorithm.<br/>default set to 'false'                                                                                                                                                                         |
