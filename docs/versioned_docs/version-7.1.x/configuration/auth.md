...
you should define the 'allowed-groups' value to admin. If you add another group, it becomes an AND operator. 
The user must be part of both groups to have access.
