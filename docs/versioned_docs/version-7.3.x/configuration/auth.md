...
For TOTVS, is needed to contact 

TOTVS is a big tech company from Brazil, if you are a customer, you can use this provider with your credantials.

Start the proxy up with the following options:
