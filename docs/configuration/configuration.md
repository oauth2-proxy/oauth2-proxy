...
| `--keep-alive` | duration | the interval between keep-alive probes for an active network connection | 30s |
...
| `--timeout` | duration | the maximum amount of time a network dial will wait for a connect to complete | 30s |
