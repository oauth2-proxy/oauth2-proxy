...
DOCKER_BUILD := docker buildx build --platform linux/amd64,linux/arm64,linux/armv6 --build-arg VERSION=${VERSION}
...
.PHONY: docker-push
docker-push:
	docker buildx build --push --platform linux/amd64,linux/arm64,linux/armv6 -t $(REGISTRY)/oauth2-proxy:latest .
